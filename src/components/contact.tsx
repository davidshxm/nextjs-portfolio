        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                <a 
                  ...
                  className="p-3 bg-blue-700 rounded-full hover:bg-white hover:text-blue-600 transition-all duration-300"
                  aria-label="LinkedIn"
                >
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="p-3 bg-blue-700 rounded-full hover:bg-white hover:text-pink-600 transition-all duration-300"
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="p-3 bg-blue-700 rounded-full hover:bg-white hover:text-blue-800 transition-all duration-300"
                  aria-label="Facebook"
                >
          ...
          <div className="p-10">
            ...
            >
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                Send Message
              </button>
            </form>
